<%@ Page Title="" Language="C#" MasterPageFile="~/Special/SpecialMasterPage.master" AutoEventWireup="true" CodeFile="PanchayatGallery.aspx.cs" Inherits="Special_PanchayatGallery" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ul class="breadcrumb push-down-0">
        <li><a href="../Default.aspx">Home</a></li>
        <li><a href="Panchayat.aspx">કણભા ગ્રામ પંચાયત</a></li>
        <li class="active">Panchayat Gallery</li>
    </ul>
    <!-- END BREADCRUMB -->
    <!-- START CONTENT FRAME -->
    <div class="content-frame">
        ...
        <div class="content-frame-top">
            <div class="page-title">
                <h2>
                    <span class="fa fa-image"></span>&nbsp;Gram Panchayat Gallery :-</h2>
            </div>
