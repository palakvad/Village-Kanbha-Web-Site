<%@ Page Title="" Language="C#" MasterPageFile="~/Special/SpecialMasterPage.master"
    AutoEventWireup="true" CodeFile="Gallery.aspx.cs" Inherits="Special_Gallery" %>
    ...
    <div class="content-frame">
        ...
        <div class="content-frame-top">
            <div class="page-title">
                <h2>
                    <span class="fa fa-image"></span>&nbsp;General Gallery :-</h2>
            </div>
        ...
        <div class="content-frame-right">
            ...
            <div class="list-group border-bottom push-down-20">
                <a href="Gallery.aspx" class="list-group-item active">General </a><a href="NavratriGallery.aspx"
                    class="list-group-item ">નવરાત્રી </a><a href="MedoGallery.aspx" class="list-group-item">
                        મેળો </a><a href="GaneshGallery.aspx" class="list-group-item">ગણેશ ઉત્સવ</a>
