<%@ Page Title="" Language="C#" MasterPageFile="~/Special/SpecialMasterPage.master" AutoEventWireup="true" CodeFile="MedoGallery.aspx.cs" Inherits="Special_MedoGallery" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ul class="breadcrumb push-down-0">
        <li><a href="../Default.aspx">Home</a></li>
        <li class="active">Medo Gallery</li>
    </ul>
    <!-- END BREADCRUMB -->
    <!-- START CONTENT FRAME -->
    <div class="content-frame">
        ...
        <div class="content-frame-top">
            <div class="page-title">
                <h2>
                    <span class="fa fa-image"></span>&nbsp;Medo Gallery :-</h2>
            </div>
        ...
        <div class="content-frame-right">
            <h4>
             ...
             <div class="list-group border-bottom push-down-20">
                ...
                <a href="MedoGallery.aspx" class="list-group-item active">મેળો </a>
