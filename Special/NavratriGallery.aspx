<%@ Page Title="" Language="C#" MasterPageFile="~/Special/SpecialMasterPage.master" AutoEventWireup="true" CodeFile="NavratriGallery.aspx.cs" Inherits="Special_NavratriGallery" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ul class="breadcrumb push-down-0">
        <li><a href="../Default.aspx">Home</a></li>
        <li class="active">Navratri Gallery</li>
    </ul>
    <!-- END BREADCRUMB -->
    <!-- START CONTENT FRAME -->
    <div class="content-frame">
        ...
        <div class="content-frame-top">
            <div class="page-title">
                <h2>
                    <span class="fa fa-image"></span>&nbsp;Navratri Gallery :-</h2>
            </div>
        ...
        <div class="content-frame-right">
            ...
            <div class="list-group border-bottom push-down-20">
                ...
                <a href="NavratriGallery.aspx" class="list-group-item active">નવરાત્રી </a>
                <a href="MedoGallery.aspx" class="list-group-item">મેળો </a>
                <a href="GaneshGallery.aspx" class="list-group-item">ગણેશ ઉત્સવ</a>
                ...
                <asp:Repeater ID="rptr" runat="server">
                    <ItemTemplate>
                        <a class="gallery-item" href=' <%# "../" + Eval("Image") %>' title='  <%# Eval("Description") %>'
                            data-gallery>
                            <div class="image">
                                <img src='  <%# "../" + Eval("Image") %>' alt="" style="height:142px; width:192px;" />
                            </div>
                            <div class="meta">
